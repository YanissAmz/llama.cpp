...
void ggml_compute_forward_hc_sinkhorn(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_hc_combine(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_hc_wsum(const struct ggml_compute_params * params, struct ggml_tensor * dst);
